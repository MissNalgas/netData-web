...
export default function ColorGuide({className = ""} : ColorGuideProps) {
	...
	return (
		<div className={"flex w-full justify-evenly mt-5 mb-3" + className}>
			<div className="flex border py-1 cel:px-3 desktop:px-7 rounded-md items-center">
				<div className="w-3 h-3 bg-red10 mr-2"/>
				<BodyTwo $weight={600} $color={theme.colors.red30}>{t("status_pending")}</BodyTwo>
			</div>
			<div className="flex border cel:px-3 desktop:px-7 rounded-md items-center">
